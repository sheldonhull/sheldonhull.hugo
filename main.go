...
const contentDir string = "/home/vscode/workspace/sheldonhull.hugo/content/blog"
const jsonOut string = "/home/vscode/workspace/sheldonhull.hugo/algolia.json"
...
func main() {
	...
	for i, f := range files {
		...
		item := AlgoliaIndex{Title: fm["title"].(string)}

		log.Debug().Msgf("Front Matter: %v", fm)
		log.Info().Msg("Returned front matter for: " + filename)
