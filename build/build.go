// Task template started from great example with: https://github.com/pellared/fluentassert/blob/main/build/build.go which avoids polluting the main directory with build file contents.
// UI from bubbletea examples textinputs
